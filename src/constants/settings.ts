...
export const settingsDefinitions: SettingsItems = {
  ...
  zoomMeetingManagerEnableWaitingRoom: {
    depends: 'zoomMeetingManagerEnable',
    group: 'integrations',
    platforms: ['win32'],
    subgroup: 'zoomMeetingManager',
...
export const defaultSettings: SettingsValues = {
  ...
  zoomMeetingManagerEnableWaitingRoom: false,
  zoomMeetingManagerMeetingId: null,
  zoomMeetingManagerPassword: null,
  zoomMeetingManagerUsername: null,
