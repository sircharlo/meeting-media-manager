...
// 98.8% translated as of 2026-08-04
import et from './et.json' with { type: 'json' };

// 98.3% translated as of 2026-08-04
import sl from './sl.json' with { type: 'json' };

// 98.2% translated as of 2026-08-04
import fr from './fr.json' with { type: 'json' };

// 91.6% translated as of 2026-08-04
import ty from './ty.json' with { type: 'json' };

// 91.3% translated as of 2026-08-04
import it from './it.json' with { type: 'json' };

// 82.0% translated as of 2026-08-04
import pt from './pt.json' with { type: 'json' };

// 67.8% translated as of 2026-08-04
import de from './de.json' with { type: 'json' };

// 60.4% translated as of 2026-08-04
import ru from './ru.json' with { type: 'json' };

// 56.9% translated as of 2026-08-04
import nl from './nl.json' with { type: 'json' };

// 52.4% translated as of 2026-08-04
import ko from './ko.json' with { type: 'json' };

// 51.2% translated as of 2026-08-04
import es from './es.json' with { type: 'json' };

// 47.7% translated as of 2026-08-04
import hu from './hu.json' with { type: 'json' };

// 40.5% translated as of 2026-08-04
