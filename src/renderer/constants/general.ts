...
/* export const LFF_PRINTED_PAGE = (lang: string, lesson: string, page: string) =>
  `https://assetsnffrgf-a.akamaihd.net/assets/m/11020212${lesson}/${lang}/art/1102021232_${lang}_seg_0${page}_xl.jpg` */
