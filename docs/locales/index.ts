...
// 100.0% translated as of 2026-09-15
import en from './en.json' with { type: 'json' };

// 99.2% translated as of 2026-09-15
import fr from './fr.json' with { type: 'json' };

// 99.0% translated as of 2026-09-15
import sl from './sl.json' with { type: 'json' };

// 98.5% translated as of 2026-09-15
import ko from './ko.json' with { type: 'json' };

// 98.5% translated as of 2026-09-15
import ty from './ty.json' with { type: 'json' };

// 98.4% translated as of 2026-09-15
import es from './es.json' with { type: 'json' };

// 98.4% translated as of 2026-09-15
import it from './it.json' with { type: 'json' };

// 96.9% translated as of 2026-09-15
...
// 52.9% translated as of 2026-09-15
import ru from './ru.json' with { type: 'json' };

// 49.7% translated as of 2026-09-15
import nl from './nl.json' with { type: 'json' };

// 41.7% translated as of 2026-09-15
import hu from './hu.json' with { type: 'json' };

// 35.4% translated as of 2026-09-15
import uk from './uk.json' with { type: 'json' };

// 0.5% translated as of 2026-09-15
// import zh from './zh.json' with { type: 'json' };

// 0.4% translated as of 2026-09-15
// import bzs from './bzs.json' with { type: 'json' };

// 0.0% translated as of 2026-09-15
