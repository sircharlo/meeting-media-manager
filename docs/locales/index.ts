...
// 100.0% translated as of 2026-09-07
...
// 96.1% translated as of 2026-09-07
import it from './it.json' with { type: 'json' };

// 95.6% translated as of 2026-09-07
import et from './et.json' with { type: 'json' };

// 72.1% translated as of 2026-09-07
import pt from './pt.json' with { type: 'json' };

// 59.8% translated as of 2026-09-07
import de from './de.json' with { type: 'json' };

// 53.3% translated as of 2026-09-07
import ru from './ru.json' with { type: 'json' };

// 50.1% translated as of 2026-09-07
import nl from './nl.json' with { type: 'json' };

// 45.6% translated as of 2026-09-07
import es from './es.json' with { type: 'json' };

// 42.0% translated as of 2026-09-07
import hu from './hu.json' with { type: 'json' };

// 35.6% translated as of 2026-09-07
import uk from './uk.json' with { type: 'json' };

// 0.5% translated as of 2026-09-07
// import zh from './zh.json' with { type: 'json' };

// 0.4% translated as of 2026-09-07
// import bzs from './bzs.json' with { type: 'json' };

// 0.0% translated as of 2026-09-07
