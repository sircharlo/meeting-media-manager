...
// 100.0% translated as of 2026-07-29
import en from './en.json' with { type: 'json' };

// 99.1% translated as of 2026-07-29
import sl from './sl.json' with { type: 'json' };

// 99.0% translated as of 2026-07-29
import fr from './fr.json' with { type: 'json' };

// 98.5% translated as of 2026-07-29
import ty from './ty.json' with { type: 'json' };

// 98.4% translated as of 2026-07-29
import pt from './pt.json' with { type: 'json' };

// 98.2% translated as of 2026-07-29
import et from './et.json' with { type: 'json' };

// 98.2% translated as of 2026-07-29
import it from './it.json' with { type: 'json' };

// 97.8% translated as of 2026-07-29
import es from './es.json' with { type: 'json' };

// 97.3% translated as of 2026-07-29
import ru from './ru.json' with { type: 'json' };

// 97.2% translated as of 2026-07-29
import nl from './nl.json' with { type: 'json' };

// 97.1% translated as of 2026-07-29
import de from './de.json' with { type: 'json' };

// 93.4% translated as of 2026-07-29
import hu from './hu.json' with { type: 'json' };

// 66.1% translated as of 2026-07-29
import uk from './uk.json' with { type: 'json' };

// 64.4% translated as of 2026-07-29
import ko from './ko.json' with { type: 'json' };

// 0.9% translated as of 2026-07-29
