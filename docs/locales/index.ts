...
// 99.2% translated as of 2026-08-24
import sl from './sl.json' with { type: 'json' };

// 99.1% translated as of 2026-08-24
import fr from './fr.json' with { type: 'json' };

// 98.7% translated as of 2026-08-24
import ty from './ty.json' with { type: 'json' };

// 98.3% translated as of 2026-08-24
import it from './it.json' with { type: 'json' };

// 94.6% translated as of 2026-08-24
import cmnHans from './cmn-hans.json' with { type: 'json' };

// 93.6% translated as of 2026-08-24
import et from './et.json' with { type: 'json' };

// 74.6% translated as of 2026-08-24
import pt from './pt.json' with { type: 'json' };

// 61.8% translated as of 2026-08-24
import de from './de.json' with { type: 'json' };

// 57.9% translated as of 2026-08-24
import ko from './ko.json' with { type: 'json' };

// 55.0% translated as of 2026-08-24
import ru from './ru.json' with { type: 'json' };

// 51.8% translated as of 2026-08-24
import nl from './nl.json' with { type: 'json' };

// 46.5% translated as of 2026-08-24
import es from './es.json' with { type: 'json' };

// 43.5% translated as of 2026-08-24
import hu from './hu.json' with { type: 'json' };

// 36.9% translated as of 2026-08-24
