...
// 98.7% translated as of 2026-09-06
import ty from './ty.json' with { type: 'json' };

// 98.4% translated as of 2026-09-06
...
// 97.7% translated as of 2026-09-06
import fr from './fr.json' with { type: 'json' };

// 96.7% translated as of 2026-09-06
import it from './it.json' with { type: 'json' };

// 96.2% translated as of 2026-09-06
import et from './et.json' with { type: 'json' };

// 72.6% translated as of 2026-09-06
import pt from './pt.json' with { type: 'json' };

// 60.2% translated as of 2026-09-06
import de from './de.json' with { type: 'json' };

// 53.6% translated as of 2026-09-06
import ru from './ru.json' with { type: 'json' };

// 50.4% translated as of 2026-09-06
import nl from './nl.json' with { type: 'json' };

// 45.9% translated as of 2026-09-06
import es from './es.json' with { type: 'json' };

// 42.3% translated as of 2026-09-06
import hu from './hu.json' with { type: 'json' };

// 35.9% translated as of 2026-09-06
