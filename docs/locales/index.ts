...
// 96.9% translated as of 2026-07-14
...
// 95.7% translated as of 2026-07-14
import ru from './ru.json' with { type: 'json' };

// 95.6% translated as of 2026-07-14
import nl from './nl.json' with { type: 'json' };

// 95.5% translated as of 2026-07-14
import de from './de.json' with { type: 'json' };

// 95.4% translated as of 2026-07-14
import ty from './ty.json' with { type: 'json' };

// 95.2% translated as of 2026-07-14
import hu from './hu.json' with { type: 'json' };

// 93.9% translated as of 2026-07-14
import et from './et.json' with { type: 'json' };

// 65.3% translated as of 2026-07-14
import ko from './ko.json' with { type: 'json' };

// 64.1% translated as of 2026-07-14
