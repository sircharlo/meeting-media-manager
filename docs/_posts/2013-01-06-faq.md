...
**No.** The JW.org [Terms of Use](https://www.jw.org/en/terms-of-use){:target="_blank"} actually explicitly allow the kind of usage that we are making. Here is the relevant excerpt from those terms (emphasis mine):
