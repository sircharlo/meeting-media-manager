...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      If conducting <strong>remote-only</strong> congregation Zoom meetings, look into activating the <code>Convert media to MP4 format</code> option and sharing the media with Zoom's native MP4 sharing instead.</blockquote>
      </td>
    </tr>
    <tr>
