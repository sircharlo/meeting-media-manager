...
**No.** Las [Condiciones de Uso](https://www.jw.org/finder?docid=1011511&prefer=content) de la web oficial de los Testigos de Jehová permiten explícitamente el tipo de uso que estamos haciendo. Aquí está el extracto relevante de esos términos (énfasis mío):
...
Por favor [archiva un problema](https://github.com/sircharlo/meeting-media-manager/issues) en el repositorio oficial de GitHub. Include:
...
Por favor [abre una discusión](https://github.com/sircharlo/meeting-media-manager/discussions) en el repositorio oficial de GitHub. Describe:
...
Por favor [vea la guía de contribución](https://github.com/sircharlo/meeting-media-manager/blob/master/CONTRIBUTING.md) en el repositorio oficial de GitHub. We welcome code contributions and Pull Requests!
