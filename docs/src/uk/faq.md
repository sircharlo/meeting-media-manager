...
**Ні.** Умови використання офіційного вебсайту Свідків Єгови насправді прямо дозволяють таке використання, яке ми здійснюємо. Ось відповідний уривок з цих умов (з виділенням):
