...
**No.** The Terms of Use of the official website of Jehovah's Witnesses explicitly allow the kind of usage that we are making. Ось відповідний уривок з цих умов (з виділенням):
