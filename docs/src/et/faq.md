...
Palun [esitage probleem](https://github.com/sircharlo/meeting-media-manager/issues) ametlikus GitHubi keskkonnas. Include:
...
Palun [ava arutelu](https://github.com/sircharlo/meeting-media-manager/discussions) ametlikus GitHubi keskkonnas. Describe:
...
Palun [vaata juhendmaterjali](https://github.com/sircharlo/meeting-media-manager/blob/master/CONTRIBUTING.md) ametlikus GitHubi keskkonnas. We welcome code contributions and Pull Requests!
