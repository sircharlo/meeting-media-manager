  ...
  app.on('ready', () => {
    ...
    session.defaultSession.webRequest.onHeadersReceived((details, callback) => {
      ...
      details.responseHeaders['Content-Security-Policy'] = [
        "default-src 'self'; script-src 'self' https: 'unsafe-inline' 'unsafe-eval'; style-src 'self' https: 'unsafe-inline'; img-src 'self' file: https:; connect-src 'self' https:; font-src 'self' file: https: data:; media-src 'self' file: https:; worker-src 'self' blob: file:;",
      ];
