...
- ✨ **Відсутнє медіа Recovery**: Медіа елементи чий локальний файл було втрачено (наприклад, видалений з кешу автоматично очищати гонку або видалено вручну) Тепер відображається вимкнена кнопка відтворення, файл "missing" назва файлу, для пошуку і нової дії "Знайдіть файл " для повторного відправлення товару на диску.
