...
- ✨ **Отсутствуют Media Recovery**: медиафайлы, локальный файл которых пропущен (например, автоматически очистил гонку кэша или вручную удалил его) теперь показывать отключенную кнопку воспроизведения, "Отсутствует" заголовок с названием файла для поиска и новое действие "Locate file" для переноса элемента в файл на диск.
