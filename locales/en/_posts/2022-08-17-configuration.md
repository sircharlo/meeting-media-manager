...
| `Hide media window after media finished playing` | If enabled, the media window will be hidden immediately after each media has finished playing. <br><br> ***Note:** This setting is mostly useful for meetings held in sign-language.* |
