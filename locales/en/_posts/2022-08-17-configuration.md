...
| `Automatically play first media item` | If enabled, the first media item in the media list will be automatically start playing a configurable number of minutes before the meeting is supposed to start. |
