...
| Ajuste                                         | Explicación                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Nombre de host`                               | Dirección web del servidor WebDAV. Se requiere HTTP seguro (HTTPS). <br><br> ***Nota:** El botón de dirección Web, al hacer clic, mostrará una lista de proveedores WebDAV que son conocidos por ser compatibles con M³, y automáticamente rellenará ciertos ajustes para esos proveedores. <br><br> Esta lista se proporciona como cortesía y de ninguna manera representa un respaldo de ningún servicio o proveedor en particular. El mejor servidor es siempre el tuyo...*                                    |
