...
缩放和平移图像 或者，您也可以双击图像预览进行放大。 双击将在 1.5x、2x、3x、4x 之间切换，并返回到 1x 缩放。 您还可以按住并拖动图像来在图像周围移动。

#### 排序媒体列表

媒体列表可以通过点击屏幕右上角的排序按钮来排序。 媒体项目旁边会出现一个按钮，可用于将媒体项目在列表中向上或向下拖动。 媒体项目旁边会出现一个按钮，可用于将媒体项目在列表中向上或向下拖动。
