...
Ao contrário do Windows e do Linux, a funcionalidade de atualização automática <strong>não é** implementada no macOS e, por motivos técnicos, provavelmente nunca será. No entanto, uma das duas coisas acontecerá para usuários de Mac quando uma atualização estiver disponível:**
