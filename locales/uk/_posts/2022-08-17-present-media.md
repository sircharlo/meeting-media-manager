...
Так само, як відповідний розділ вище. З додаванням глобальної комбінації клавіш для Zoom для запуску/припинення показу екрана (<kbd>Alt S</kbd>). "Камера" буде стрічкою камери з фотоапарату Королівства.
